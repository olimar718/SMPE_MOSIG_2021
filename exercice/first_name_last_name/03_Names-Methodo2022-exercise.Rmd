...
```{r}
# We can find all the different names wih this command
...
library(dplyr)
FirstNames %>% count(preusuel) %>% arrange(desc(n)) %>% mutate(frequency=n/3727553) # todo remove hardcoding of total
