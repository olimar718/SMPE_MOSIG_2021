...
compute_mortality_ratio(smoker_arg = "Yes", df_arg = class1834,title_arg = "18 34 age class, smokers")
compute_mortality_ratio(smoker_arg = "No", df_arg = class1834,title_arg = "18 34 age class, non smokers")
compute_mortality_ratio(smoker_arg = "Yes", df_arg = class3454,title_arg = "34 54 age class, smokers")
compute_mortality_ratio(smoker_arg = "No", df_arg = class3454,title_arg = "34 54 age class, non smokers")
compute_mortality_ratio(smoker_arg = "Yes", df_arg = class5464,title_arg = "54 64 age class, smokers")
compute_mortality_ratio(smoker_arg = "No", df_arg = class5464,title_arg = "54 64 age class, non smokers")
compute_mortality_ratio(smoker_arg = "Yes", df_arg = class64,title_arg = " 64 + age class, smokers")
compute_mortality_ratio(smoker_arg = "No", df_arg = class64,title_arg = "64 + age class, non smokers")
```
...
## What is happening
I develop a function to compute to ratio of somker in a given age class
```{r}
